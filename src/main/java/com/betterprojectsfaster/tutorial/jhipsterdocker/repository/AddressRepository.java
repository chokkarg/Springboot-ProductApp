...
public interface AddressRepository extends JpaRepository<Address, Long> {
    ...
    @Query(
        value = "select distinct address from Address address left join fetch address.user",
    ...
    @Query("select distinct address from Address address left join fetch address.user")
