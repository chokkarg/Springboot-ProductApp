...
public interface ShipmentRepository extends JpaRepository<Shipment, Long> {
    ...
    @Query(
        value = "select distinct shipment from Shipment shipment left join fetch shipment.order left join fetch shipment.shippedBy",
    ...
    @Query("select distinct shipment from Shipment shipment left join fetch shipment.order left join fetch shipment.shippedBy")
